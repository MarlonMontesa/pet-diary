    ...
    public partial class UserCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    adoptCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    adoptName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    adoptCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    photoCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    photoName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    photoCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    userId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    videoCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    videoName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    videoCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    userId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    userAdoptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptComments", x => x.id);
                    table.ForeignKey(
                        name: "FK_AdoptComments_UserAdoption_userAdoptionId",
                        column: x => x.userAdoptionId,
                        principalTable: "UserAdoption",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdoptComments_Users_userId",
                        column: x => x.userId,
                        principalTable: "Users",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptComments_userAdoptionId",
                table: "AdoptComments",
                column: "userAdoptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptComments_userId",
                table: "AdoptComments",
                column: "userId");
